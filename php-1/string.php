...
<body>
    ...
    <?php   
        ...
        */
        ...
        echo "Panjang string: " . strlen($first_sentence) . ", Jumlah kata: " . str_word_count($first_sentence, 0, "'") . "<br><br>";

        echo "Kalimat 2: \"$second_sentence\"<br>";
        echo "Panjang string: " . strlen($second_sentence) . ", Jumlah kata: " . str_word_count($second_sentence, 0, "'") . "<br><br>";
